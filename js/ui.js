...
import { grades, attrIcon } from './constants.js';
import { getBattleStats } from './battle.js';
...
// 인벤토리 카드 HTML 생성 (원본 100% 동일, sellMode 변수만 인자로 받음)
export function createCardHTML(card, isZoom=false, sellMode=false, selectedForSell=new Set()){
